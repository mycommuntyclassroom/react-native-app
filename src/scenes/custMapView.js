/**
 * Created by Omkareshwar on 8/12/17.
 */
...
import MapUrlTile from 'react-native-maps/lib/components/MapUrlTile';
import AnimatedRegion from 'react-native-maps/lib/components/AnimatedRegion';
import {
  contextTypes as childContextTypes,
  getAirMapName,
  googleMapIsInstalled,
  createNotSupportedComponent,
} from 'react-native-maps/lib/components/decorateMapComponent';
import * as ProviderConstants from 'react-native-maps/lib/components/ProviderConstants';
